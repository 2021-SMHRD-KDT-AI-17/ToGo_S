...
<body>
   ...
   <div class="page-name-box">메뉴 관리 페이지</div>
   ...
   <div style="display: flex; flex-direction: column;">
      <section class="gallery-section section parallax-window"
               ...
               <c:forEach items="${m_list}" var="m" varStatus="status">
                  <div class="col"
                     ...
                     <div class="card h-300">
                        ...
                        <div class="card-body"
                           style="display: flex; justify-content: space-between; border: 1px solid lightgray; border-radius: 5px;">
         ...
         <div class="text-center mt-4"
            ...
            <button class="btn-success-add" data-bs-toggle="modal"
               data-bs-target="#exampleModal" onclick="addmenu()">메뉴 추가하기</button>
            <a href="gosoldout"><button class="btn-success-add"
         ...
         <div class="modal-content" style="width: 100%;">
            <form action="updateMenu" method="post">
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" style="width: 80px; height:60px; margin-right: 20px;"
