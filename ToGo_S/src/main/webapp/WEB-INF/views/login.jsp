...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="resources/css/main_SHS.css" type="text/css" />
</head>
			...
			<div class="form tm-contact-item-inner">
				<form action="storeLogin" method="POST">
					<div class="form-group">
						<input name="store_id" type="text" class="form-control" placeholder=" 발급된 아이디를 입력하세요">
					</div>
					<div class="form-group">
						<input name="store_pw" type="password" class="form-control"placeholder="발급된 비밀번호를 입력하세요">
					</div>
