...
%>
		<tr>
			...
			<div class="checkbox-container">
                <input type="checkbox" class="soldout-checkbox" data-menu-name=<%= rs.getString("menu_name") %>>
            </div>
            </td>
		</tr>
		<%
...
%>
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            ...
            if (this.checked) {
                console.log(menuName + ' 메뉴가 매진되었습니다.');
            } else {
                console.log(menuName + ' 메뉴가 매진 상태가 해제되었습니다.');
            }
        });
    });
	</script>
